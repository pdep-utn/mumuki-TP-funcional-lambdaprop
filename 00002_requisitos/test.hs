...
it "Un departamento con superficie de 45 no cumple con el rango de tener entre 70 y 100 m2" $ do
  (last deptosDeEjemplo) `shouldNotSatisfy` cumpleRango superficie 70 100